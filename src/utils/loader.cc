...
Record *load(const char *pathname) {
...
static void fixed_width_sprint(const char *s, int w) {
    int n_bytes = 0;
    int visual_width = 0;
...
static void show_record(int rid, Record record) {
    printf("\n%-5d | %-10d | ", rid, record.student_id);
